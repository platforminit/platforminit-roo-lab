...
# packages: keep it SMALL by default (baseline allowlist)
...
ln -sf "$(basename "$OUT")" "${OUT_DIR}/state-latest.json"

echo "Wrote: $OUT"
echo "Latest: ${OUT_DIR}/state-latest.json"
